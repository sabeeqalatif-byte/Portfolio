    ...
    <section id="resume" className="py-20 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="theme-card rounded-3xl p-8 sm:p-10 relative overflow-hidden border border-[var(--border-color)] text-center space-y-6 shadow-xl">
          ...
          {/* Icon Badge */}
          <div className="w-14 h-14 mx-auto rounded-2xl bg-[#ef98a7]/15 border border-[#ef98a7]/35 flex items-center justify-center text-[#ef98a7] shadow-sm">
            <FileText className="w-7 h-7 text-[#ef98a7]" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl mx-auto pt-2 pb-2 text-left">
            <div className="p-3.5 rounded-xl theme-subtle-box">
              <div className="flex items-center gap-1.5 text-xs font-mono font-bold text-[#ef98a7] dark:text-[#f7bea9]">
                <CheckCircle className="w-3.5 h-3.5 text-[#ef98a7]" />
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold text-[var(--text-heading)] bg-[var(--bg-card)] hover:bg-[var(--bg-card-hover)] border border-[var(--border-color)] hover:border-[#ef98a7] transition-all shadow-sm transform hover:-translate-y-0.5"
            >
