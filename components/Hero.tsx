...
export default function Hero() {
  return (
    <section id="hero" className="relative pt-28 pb-16 sm:pt-36 sm:pb-24 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[380px] bg-[#ef98a7]/10 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="absolute top-1/3 right-1/4 w-[450px] h-[320px] bg-[#f7bea9]/10 rounded-full blur-[110px] pointer-events-none -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-mono font-semibold theme-badge shadow-sm">
              <span className="w-2.5 h-2.5 rounded-full bg-[#ef98a7] animate-pulse" />
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-[#ef98a7] dark:text-[#f7bea9] font-mono tracking-tight flex items-center gap-2">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-bold text-[var(--text-heading)] bg-[var(--bg-card)] hover:bg-[var(--bg-card-hover)] border border-[var(--border-color)] hover:border-[#ef98a7] transition-all transform hover:-translate-y-0.5 shadow-sm"
              >
                <Download className="w-4 h-4 text-[#ef98a7] dark:text-[#f7bea9]" />
            ...
            <div className="pt-4 border-t border-[var(--border-color)] flex flex-wrap gap-2 text-xs font-mono">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg theme-badge font-semibold">
                <Smartphone className="w-3.5 h-3.5 text-[#ef98a7] dark:text-[#f7bea9]" />
                15+ Live Store Apps
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg theme-badge font-semibold">
                <Terminal className="w-3.5 h-3.5 text-[#807094] dark:text-[#f7bea9]" />
                Antigravity Automation
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg theme-badge font-semibold">
                <Sparkles className="w-3.5 h-3.5 text-[#604f71] dark:text-[#f7bea9]" />
                Open to Remote
              </span>
            </div>
          </div>
            ...
            <div className="theme-card rounded-2xl p-5 sm:p-6 relative overflow-hidden border border-[var(--border-color)] shadow-xl">
              ...
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-[var(--border-color)]">
                <div className="flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-[#ef98a7] inline-block" />
                  <span className="w-3 h-3 rounded-full bg-[#f7bea9] inline-block" />
                  <span className="w-3 h-3 rounded-full bg-[#807094] inline-block" />
                  <span className="text-xs font-mono text-[var(--text-muted)] ml-2 font-semibold">sqa-release-gate.audit</span>
                </div>
                <span className="px-2.5 py-0.5 text-[10px] font-mono font-bold uppercase tracking-wider text-[#604f71] dark:text-[#f7bea9] bg-[#f7bea9]/30 dark:bg-[#604f71]/50 border border-[#ef98a7]/40 rounded-md">
                  VERIFIED: 100%
                </span>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-[var(--border-color)] flex items-center justify-between text-xs text-[var(--text-muted)] font-mono">
                <div className="flex items-center gap-1.5 text-[#604f71] dark:text-[#f7bea9] font-bold">
                  <Shield className="w-3.5 h-3.5 text-[#ef98a7]" />
                  <span>SQA Lead &bull; Zeesofttech</span>
                </div>
                <span className="text-[#ef98a7] dark:text-[#f7bea9] font-bold">2+ Years Exp.</span>
              </div>
